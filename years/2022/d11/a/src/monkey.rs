...
fn parse_test(divisor: &[u8], success: &[u8], failure: &[u8]) -> Operation {
    ...
    Box::new(move |x| if x % divisor == 0 { success } else { failure })
}
